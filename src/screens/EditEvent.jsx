...
const EditEvent = () => {
  ...
  const [advanceBookings, setAdvanceBookings] = useState(
    event.advanceBookingDuration || 30
  ); // this is the number of days ahead of time for which bookings will be able to get made.
  const [selectedDays, setSelectedDays] = useState(event.offDays || []);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={4}>
                ...
                />
                <DaySelector
                  onSelectedDays={handleSelectedDay}
